 ...
 *
 * Version 2016-10-22 (Siegfried Seibert)
 * update for PHP 5.5 compatibility
 *
*/
$RecipeInfo['IncludeUpload']['Version'] = '20161022';
...
if (function_exists(Markup_e)) {
        Markup_e('includeupload', 'inline', '/\\(:includeupload(\\s+.*?):\\)/i',
    "IncludeUploadIncludeFile(\$pagename, \$m[1])");
